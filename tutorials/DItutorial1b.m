%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Data and Inference, Tutorial 1b %%%
...
fiveDates2 = fiveDates1[Dates, open, High, Low, Close,[Dates, open, High, Low, Close, Volume, AdjClose] = textread ('SP500.csv','%s%f%f%f%f%f%f', 'delimiter',',', 'headerlines',1); Volume, AdjClose] = textread ('SP500.csv','%s%f%f%f%f%f%f', 'delimiter',',', 'headerlines',1);;
...
% Plotting 
%%%%%%%%%%%%%%%%%%%%%%%%
d = datenum(Dates,'yyyy-mm-dd');
% plot the opening prices
plot(d, open);
% Review datetick function to label well the axes